...
pub struct Options {
    ...
    /// Select a predefined Scruff configuration mode.
    #[option(
        default = r#""default""#,
        value_type = r#""default" | "minimal" | "strict" | "black" | "tali""#,
        example = r#"
            # Enable comprehensive linting defaults.
            mode = "strict"
        "#
    )]
...
pub struct FormatOptions {
    ...
    /// A regular expression identifying symbol-like strings when
    /// [`quote-style`](#format_quote-style) is set to `symbol`.
    ///
    /// Matching strings use single quotes; all other strings use double quotes.
    #[option(
